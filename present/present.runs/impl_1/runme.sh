...
HD_PWD='C:/Users/Lenovo/present/present.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log present.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source present.tcl -notrace
