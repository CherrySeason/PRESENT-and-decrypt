...
HD_PWD='C:/Users/Lenovo/present/present.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log present.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source present.tcl
